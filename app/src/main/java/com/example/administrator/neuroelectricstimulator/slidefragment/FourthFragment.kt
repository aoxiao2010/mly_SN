...
class FourthFragment: Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        rootView = inflater!!.inflate(R.layout.fourthfragment,container,false)
        return rootView
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        image_equipment4.setOnTouchListener { v, event ->
...
//                R.drawable.dot) as BitmapDrawable).bitmap
        ...
        val img_width= image_equipment4.width
        val img_height = image_equipment4.height
        ...
        canvas.restore()
        image_equipment4.setImageBitmap(newBitmap)
    }
