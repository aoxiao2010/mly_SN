...
class SecondFragment: Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        rootView = inflater!!.inflate(R.layout.secondfragment,container,false)
        return rootView
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        image_equipment2.setOnTouchListener { v, event ->
...
//                R.drawable.dot) as BitmapDrawable).bitmap
        ...
        val img_width= image_equipment2.width
        val img_height = image_equipment2.height
        ...
        canvas.restore()
        image_equipment2.setImageBitmap(newBitmap)
    }
